## Choice among nine celebrities (Rumelhart & Greeno, 1971, JMP)

celebrities <- matrix(c(
   0, 159, 163, 175, 183, 179, 173, 160, 142,
...
colnames(celebrities) <- rownames(celebrities) <-
  c("LBJ", "HW", "CDG", "JU", "CY", "AJF", "BB", "ET", "SL")
names(dimnames(celebrities)) <- c(">", "<")
